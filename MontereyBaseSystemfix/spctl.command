...
options=("Add a custom id for kext consent" "Show third party ids" "Enable kext consent for virtualization" "Enable kext consent for USB Wifi" "List kext consent ids" "Disable spctl kext consent" "Quit")
...
do
    case $opt in
        ...
        "Show third party ids")
            ...
            echo "\nMicrosoft - UBF8T346G9 ; Dropbox - G7HH3F8CAK ; Cisco - DE8Y96K9QP ; Broadcom - Y2CCP3S9W7 ; HP - 6HB5Y2QTA3 ; Google - EQHXZ8M8AV ; Oracle - VB5E2TV963 ; AdobeFlash - EHWBRW848H ; Intel - Z3L495V9L4 ; BlueStacks - QX5T8D6EDU ; Kaspersky - 2Y8XE5CQ94 ; Symantec - 9PTGMPNXZ2 ; Bitdefender - GUNFMW623Y ; Trendmicro - E8P47U2H32 ; Eset - P8DQRXPVLP ; Sophos - 2H5GFH3774 ; Avast - 6H4HRTU5E3 ; Fortinet - AH4XFXJ7DK ; Crowdstrike - X9E956P446 ; Paloaltonetworks - PXPZ95SK77 ; Nvidia - 6KR3T733EC ; Realtek - ZYM2ETK3E7 ; Mediatek - ZG5MN8MJ6A ; "
	    echo "\nDone\n\npress enter to show menu\ntype 7 to exit"
            ;;
	    ...
	    /usr/sbin/spctl kext-consent add VB5E2TV963
            ...
            /usr/sbin/spctl kext-consent add Z3L495V9L4
	    echo "\nDone\n\npress enter to show menu\ntype 7 to exit"
            ;;
        "Enable kext consent for USB Wifi")
            printf '\033[1;38;5;39m'
            echo "\nEnabling kext for USB Wifi based on Realtek, Ralink and Mediatek chip"
	    /usr/sbin/spctl kext-consent add ZYM2ETK3E7
            /usr/sbin/spctl kext-consent add ZG5MN8MJ6A
	    echo "\nDone\n\npress enter to show menu\ntype 7 to exit"
            ;;
